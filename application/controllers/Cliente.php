...
class Cliente extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('cliente/index/index', array("list"=> $dts)  );
	...
	public function create(){
		...
		if( sizeof($d) ){
			...
			$dt= $this->Cliente_model->get( $d['cedula'] ) ;
			if( is_null($dt)){
				$this->Cliente_model->add();
				$this->load->view("plantillas/success", array("mensaje"=>"Datos de Cliente agregado"));
			}else {
				$this->load->view("plantillas/error", array("mensaje"=>"Este Cliente ya existe"));
			}
		}else{
